...
function MUIStats:SetHook(hook, delay)
    if hook then
        ...
        DelayedCalls:Add("ShowAAIPanel", delay or 1, f)
    else
        DelayedCalls:Remove("ShowAAIPanel")
...
function MUIStats:SetBreakHook(hook, delay)
    if hook then
        ...
        DelayedCalls:Add("ShowBreakPanel", delay or 1, f)
    else
        DelayedCalls:Remove("ShowBreakPanel")
