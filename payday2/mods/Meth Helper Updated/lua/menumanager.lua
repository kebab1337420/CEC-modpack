...
function MethHelperUpdated:UseMessageAllCaps()
	return self.settings.message_allcaps
end
...
Hooks:Add( "MenuManagerInitialize", "MenuManagerInitialize_MethHelperUpdated", function(menu_manager)
	...
	MenuCallbackHandler.callback_methhelperupdated_message_allcaps = function(self,item)
		MethHelperUpdated.settings.message_allcaps = item:value() == "on"
		MethHelperUpdated:Save()
	end
